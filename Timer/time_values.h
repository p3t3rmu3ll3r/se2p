...
#define TIME_VALUE_CLOSE_GATE_MSEC 800
...
#define TIME_VALUE_SEG1_MAX_MSEC 400

#define TIME_VALUE_SEG2_MIN_SEC 0
#define TIME_VALUE_SEG2_MIN_MSEC 500
#define TIME_VALUE_SEG2_MAX_SEC 1
#define TIME_VALUE_SEG2_MAX_MSEC 200

#define TIME_VALUE_SEG3_MIN_SEC 1
#define TIME_VALUE_SEG3_MIN_MSEC 600
#define TIME_VALUE_SEG3_MAX_SEC 2
#define TIME_VALUE_SEG3_MAX_MSEC 0
